...
//            fixed.getTableHeader().setSize(200, 200);
//            fixed.getColumnModel().getColumn(0).setWidth(500);


            TableCellRenderer headerRenderer = new VerticalTableHeaderCellRenderer();
            fixed.getTableHeader().setDefaultRenderer(headerRenderer);
//            fixed.getTableHeader().setAutoscrolls(true);
//            fixed.getTableHeader().setPreferredSize(new Dimension(150, 150));
            fixed.setRowHeight(fixed.getRowHeight() + 10);
//            fixed.getTableHeader().setPreferredSize(new Dimension(-1, 100));
//            fixed.getTableHeader().setMinimumSize(new Dimension(-1, 100));
